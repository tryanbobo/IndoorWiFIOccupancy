...
# Load the datasets
path_wifi = r"C:\Users\tb1302\OneDrive - Texas State University\IndStudy_Bobo\Data\WifiData\output\agg"
...
wifi_data['Datetime'] = pd.to_datetime(wifi_data['Datetime']).dt.tz_localize(None)
...
merged_data.to_csv(r"C:\Users\tb1302\OneDrive - Texas State University\IndStudy_Bobo\Data\Analysis\RQ3_wifi-rfid\RQ3_wifi-rfid.csv")
print(merged_data)
...
plt.xlabel('Datetime')
plt.ylabel('Count')
plt.title('Comparison of Total (Wifi) and Ins (RFID) Data')
plt.legend()
plt.grid()
