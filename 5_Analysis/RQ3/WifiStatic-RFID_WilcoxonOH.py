...
plt.title('Comparison of Static Wi-Fi Counts and RFID "In" Count', fontsize=14)
plt.legend()
plt.grid()
...
plt.title('Correlation between Static Wi-Fi Counts and RFID "In" Count', fontsize=14)
