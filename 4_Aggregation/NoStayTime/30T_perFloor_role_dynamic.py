...
merged_data.to_csv(os.path.join(path, 'agg\FloorCounts_30min_dynamic.csv'), index=False)
...
ax.legend()
ax.set_title('Counts of Every Floor at Every 30-minute Interval: Dynamic Filter')
