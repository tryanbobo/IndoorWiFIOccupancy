...
building_totals.to_csv(os.path.join(path, 'agg/BuildingCounts_30min_static.csv'), index=False)
...
ax.legend()
ax.set_title('Counts of Building Total at Every 30-minute Interval: Static Filter')
