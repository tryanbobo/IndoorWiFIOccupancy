...
building_totals.to_csv(os.path.join(path, 'agg/BuildingCounts_60min_dynamic.csv'), index=False)
...
ax.legend()
ax.set_title('Counts of Building Total at Every 1-hour Interval: Dynamic Filter')
